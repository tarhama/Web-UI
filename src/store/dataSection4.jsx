export const  DataSect4 = {
    ...
    checklistTexts: [
        {
            id: 1,
            boldText: 'Simplified email marketing',
            text: 'that syncs with your site and store'
        },
        {
            id: 2,
            boldText: 'Engage your customers',
            text: '& promote your brand with emails you design and send in minutes'
        },
        {
            id: 3,
            boldText: 'Get found on Google:',
